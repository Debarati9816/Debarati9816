...
-Generates passwords using a mix of uppercase and lowecase letters, digits and special characters. It allows users to specify the desired length of the password and the user can choose wheather to include special characters in the password.
